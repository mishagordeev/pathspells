            ...
            children: [
              ...
              TextSpan(
                ...
                recognizer: new TapGestureRecognizer()
                  ..onTap = () { launch('https:paizo.com/communityuse');
                  }
              ),
              TextSpan(
                text: ". For more information about Paizo Inc. and Paizo products, please visit "
              ),
              TextSpan(
                text: "paizo.com",
                style: TextStyle(color: Colors.red[900],fontWeight: FontWeight.bold),
                recognizer: new TapGestureRecognizer()
                  ..onTap = () { launch('https://paizo.com');
                  }
              ),
              TextSpan(
                text: ".\n\n"
              ...
              TextSpan(
                text: "   All spells are taken from "
              ),
              TextSpan(
                text: "Archives of Nethys",
                style: TextStyle(color: Colors.red[900],fontWeight: FontWeight.bold),
                recognizer: new TapGestureRecognizer()
                  ..onTap = () { launch('https://aonprd.com');
              }
              ),
              TextSpan(
                text: " website. Thank Blake Davis for his great work!\n\n"
              ),
              TextSpan(
                text: " F ",
                style: TextStyle(backgroundColor: Colors.red[900].withOpacity(0.7), color: Colors.white, letterSpacing: 0.8),
              ),
              TextSpan(
              ...
              TextSpan(
                text: " M ",
                style: TextStyle(backgroundColor: Colors.red[900].withOpacity(0.7), color: Colors.white, letterSpacing: -0.5),
              ),
              TextSpan(
              ...
              TextSpan(
                text: " R ",
                style: TextStyle(backgroundColor: Colors.red[900].withOpacity(0.7), color: Colors.white, letterSpacing: 0.6),
              ),
              TextSpan(
